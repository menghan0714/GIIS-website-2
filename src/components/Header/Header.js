        ...
        <header className={`${styles.header}`}>
            ...
            <div className="row align-items-center">
                ...
                <div className="col-3 col-md-2 col-lg-2 d-flex  justify-content-center">
                    ...
                    <a href="https://moodles.genesisideas.school" target="_blank" rel="noopener noreferrer" className="btn btn-link px-2"  style={{ fontSize: '9px' }}>Moodles</a>
                    <button className={`btn btn-link px-2 ${styles.button}`} onClick={toggleLanguage} style={{ fontSize: '9px' }}>
